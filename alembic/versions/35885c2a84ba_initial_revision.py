...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('family_type', 'state', 'place', 'year', 'analysis_type')
    )
    ...
    op.create_table('geo_identifier',
    sa.Column('state', sa.String(), nullable=False),
    sa.Column('place', sa.String(), nullable=False),
    ...
    sa.PrimaryKeyConstraint('family_type', 'place', 'state', 'year', 'analysis_type')
    )
    op.create_table('puma',
    ...
    op.create_table('self_sufficiency_standard',
    sa.Column('family_type', sa.String(), nullable=False),
    sa.Column('state', sa.String(), nullable=False),
    sa.Column('place', sa.String(), nullable=False),
    sa.Column('year', sa.Integer(), nullable=False),
